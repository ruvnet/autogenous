...
- Status: **Accepted** · Item 1 (VerifiedPromotion) **Implemented**; items 2–4 **Accepted-design, pending**
- Date: 2026-08-16
...
### 4. Durable recovery (ACCEPTED-DESIGN, pending)
...
- Real-traffic canary, 60 s exact-parent restore, restart reconstruction — **pending
  items 2 & 4**; the in-memory adapter proves the state machine and the timed
  rollback SLO, not real traffic or persistence.
